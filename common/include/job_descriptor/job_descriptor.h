...
class JobDescriptor 
{
  ...
  public:
    ...
    static void SetImageSize(JOB_DESCRIPTOR_IMPL *const job_descriptor_impl, const int image_size) {
        job_descriptor_impl->IMAGE_SIZE = image_size;
    }

    static void SetImageCount(JOB_DESCRIPTOR_IMPL *const job_descriptor_impl, const int image_count) {
        job_descriptor_impl->LDR_IMAGE_COUNT = image_count;
    }

    static void AddInputImageLocation(JOB_DESCRIPTOR_IMPL *const job_descriptor_impl, PIXEL_T * const input_location, const int image_num) {
        job_descriptor_impl->INPUT_IMAGES[image_num] = input_location;
    }

    static void CopyToRawBuffer(BYTE_T *raw_buffer, const JOB_DESCRIPTOR_IMPL *const job_descriptor_impl) {
    ...
    static JOB_DESCRIPTOR_IMPL *InterpretRawBufferAsJobDescriptor(BYTE_T *raw_buffer) {
    ...
    static const int NumberOfLDRImages(const JOB_DESCRIPTOR_IMPL *const job_descriptor_impl) {
        ASSERT(job_descriptor_impl != nullptr, "job_descriptor_impl == nullptr");
        return job_descriptor_impl->LDR_IMAGE_COUNT;
    }

    static const int ImageSize(const JOB_DESCRIPTOR_IMPL *const job_descriptor_impl) {
        ASSERT(job_descriptor_impl != nullptr, "job_descriptor_impl == nullptr");
        return job_descriptor_impl->IMAGE_SIZE;
    }

    static const PIXEL_T *OutputImageLocation(const JOB_DESCRIPTOR_IMPL *const job_descriptor_impl) {
        ASSERT(job_descriptor_impl != nullptr, "job_descriptor_impl == nullptr");
        return job_descriptor_impl->OUTPUT_IMAGE_LOCATION;
    }

    static const PIXEL_T *InputImageLocation(const JOB_DESCRIPTOR_IMPL *const job_descriptor_impl, const int image_num) {
        ASSERT(job_descriptor_impl != nullptr, "job_descriptor_impl == nullptr");
